...
<section class="page-section" id="contact">
    <div class="container">
        <div class="text-center">
            ...
            <h3 class="section-subheading text-muted">If you have any questions about the wedding please feel free to get in touch. <br>We will try get in touch as soon as we see message :)</h3>
        </div>

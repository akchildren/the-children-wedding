...
<div class="row justify-content-md-center">
    ...
    <div class="col-lg-2">
        <div class="team-member">
            <img class="mx-auto rounded-circle" src="{{asset(env('ASSET_LOCATION').'/img/people/sarah.jpeg')}}" alt="..." />
    ...
    <div class="col-lg-2">
        <div class="team-member">
            <img class="mx-auto rounded-circle" src="{{asset(env('ASSET_LOCATION').'/img/people/holly.jpg')}}" alt="..." />
            <h4>Holly Milner</h4>
            <p class="text-muted">Bridesmaid</p>
        </div>
    </div>
    <div class="col-lg-2">
        <div class="team-member">
            <img class="mx-auto rounded-circle" src="{{asset(env('ASSET_LOCATION').'/img/people/amy.jpeg')}}" alt="..." />
            <h4>Amy Durrant</h4>
            <p class="text-muted">Bridesmaid</p>
        </div>
    </div>
    <div class="col-lg-2">
        <div class="team-member">
            <img class="mx-auto rounded-circle" src="{{asset(env('ASSET_LOCATION').'/img/people/lucy.jpg')}}" alt="..." />
            <h4>Lucy Children</h4>
            <p class="text-muted">Bridesmaid</p>
        </div>
    </div>

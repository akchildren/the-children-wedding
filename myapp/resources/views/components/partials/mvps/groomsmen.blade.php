...
<div class="row justify-content-md-center">
    <div class="col-lg-2">
        <div class="team-member">
            <img class="mx-auto rounded-circle" src="{{asset(env('ASSET_LOCATION').'/img/people/danny.jpg')}}" alt="..." />
            <h4>Danny Tull</h4>
    ...
    <div class="col-lg-2">
        <div class="team-member">
            <img class="mx-auto rounded-circle" src="{{asset(env('ASSET_LOCATION').'/img/people/liam.jpeg')}}" alt="..." />
            <h4>Liam Askew</h4>
    ...
    <div class="col-lg-2">
        <div class="team-member">
            <img class="mx-auto rounded-circle" src="{{asset(env('ASSET_LOCATION').'/img/people/seb.jpg')}}" alt="..." />
            <h4>Seb Durrant</h4>

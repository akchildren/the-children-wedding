<section class="page-section" id="Timings">
    <div class="container">
        <div class="row text-center">
            <h2 class="section-heading text-uppercase">Key Times</h2>
            <h3 class="section-subheading text-muted mb-3">Here are the list of key times for guest arrivals:</h3>
            <ul class="list-group">
